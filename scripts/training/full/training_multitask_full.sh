...
# Florence-2 多任务训练 Full Training 脚本
...
# 配置文件路径
CONFIG_PATH="configs/full/multitask_training.yaml"
...
# 输出目录
OUTPUT_DIR="./outputs/florence2_multitask_full"
...
echo "开始 Florence-2 多任务训练 Full Training..."
