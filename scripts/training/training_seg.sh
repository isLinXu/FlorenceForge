...
python3 -m florence_forge.cli.main train \
    ...
    --config /svap_storage/gatilin/workspaces/working/GatilinLAB/vlm_learning/FlorenceForge/florence_forge/configs/examples/segmentation_training.yaml \
    --train-data /svap_storage/dataset/SVAP_Public_Datasets/coco/annotations/florence2_region_segmentation.jsonl \
    --val-data /svap_storage/dataset/SVAP_Public_Datasets/coco/annotations/florence2_region_segmentation_test.jsonl \
    --output-dir /svap_storage/gatilin/workspaces/working/GatilinLAB/vlm_learning/FlorenceForge/outputs/florence2_seg \
    --epochs 2 \
    --batch-size 32 \
    --learning-rate 1e-5
    # --epochs 2 \
