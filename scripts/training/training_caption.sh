...
python3 -m florence_forge.cli.main train \
    ...
    --train-data /svap_storage/gatilin/workspaces/working/GatilinLAB/vlm_learning/Florence-2-Fine-tuning-main/MIRA/data/coco_caption/coco_train_caption.jsonl \
    --val-data /svap_storage/gatilin/workspaces/working/GatilinLAB/vlm_learning/Florence-2-Fine-tuning-main/MIRA/data/coco_caption/coco_val_caption.jsonl \
    --output-dir /svap_storage/gatilin/workspaces/working/GatilinLAB/vlm_learning/FlorenceForge/outputs/florence2_caption \
    --epochs 1 \
    --batch-size 64 \
    --learning-rate 1e-5
    # --epochs 2 \
