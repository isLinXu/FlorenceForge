...
# OUTPUT_DIR=./results_segment
# OUTPUT_DIR=./results_segment1
# OUTPUT_DIR=./results_segment2
# OUTPUT_DIR=./results_segment3
# OUTPUT_DIR=./results_segment4
# OUTPUT_DIR=./results_segment5
# OUTPUT_DIR=./results_segment6
# OUTPUT_DIR=./results_segment7
